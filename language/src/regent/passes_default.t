...
local optimize_predicated_execution = require("regent/optimize_predicated_execution")
...
if std.config["optimize_predicated_execution"] then passes_hooks.add_optimization(40, optimize_predicated_execution) end
